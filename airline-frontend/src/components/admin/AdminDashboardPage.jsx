                                    ...
                                    <div key={booking.id} className="admin-booking-card">
                                        ...
                                        <div className="admin-booking-details">
                                            ...
                                            <div className="admin-booking-actions">
                                                <Link to={`/admin/booking/${booking.id}`} className="admin-view-details">
                                                    View/Manage
                                                </Link>
                                            </div>
                                        </div>
                                ...
                                flights.map(flight => (
                                    <div key={flight.id} className="admin-flight-card">
                                        <div className="admin-flight-header">
                                            <div className="admin-flight-number">{flight.flightNumber}</div>
                                        ...
                                        <div className="admin-flight-details">
                                            ...
                                            <div className="admin-flight-actions">
                                                <Link to={`/admin/flight/${flight.id}`} className="admin-manage-flight">
                                                    Manage Flight
                                                </Link>
                                            </div>
                                        </div>
