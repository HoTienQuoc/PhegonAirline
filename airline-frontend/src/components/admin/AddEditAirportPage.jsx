                ...
                <form onSubmit={handleSubmit} className="airport-form">  
                    <div className="form-group">
                        ...
                        <input
                            type="text"
                            id="name" name="name"
                            value={airport.name} onChange={handleChange}
                            required/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="city">City</label>
                        <select
                        id="city" name="city" value={airport.city} onChange={handleChange}
                        required>
                    ...
                    <div className="form-group">
                        ...
                        <select
                            ...
                            value={airport.country} onChange={handleChange}
                            required>
                            <option value="">Select country</option>
                            {countries.map(country => (
                                <option key={country} value={country}>{country.replace(/_/g, " ")}</option>
                            ))}
                        </select>
                    </div>
                    <div className="form-group">
                        ...
                        <input
                            ...
                            id="iataCode"
                            name="iataCode"
                            value={airport.iataCode} onChange={handleChange}
