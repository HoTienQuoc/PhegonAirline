...
export default class ApiService{
    ...
    static async getAllAirports() {      
        const resp = await axios.post(`${this.BASE_URL}/airports`);
        return resp.data;
    }

    static async getAirportById(id) {      
        const resp = await axios.post(`${this.BASE_URL}/airports/${id}`);
        return resp.data;
    }
    ...
    static async getBookingById(id){
        const resp = await axios.post(`${this.BASE_URL}/bookings/${id}`, {
            headers: this.getHeader()
        })
        return resp.data;
    }
