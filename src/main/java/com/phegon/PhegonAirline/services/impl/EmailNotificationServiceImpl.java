...
import com.phegon.PhegonAirline.repo.EmailNotificationRepo;
...
public class EmailNotificationServiceImpl implements EmailNotificationService{
    ...
    public void sendBookingTickerEmail(Booking booking) {
        ...
        templateVariables.put ("departureAirportIataCode", booking.getFlight().getDepartureAirport().getIaataCode());
        ...
        templateVariables.put("arrivalAirportIataCode", booking.getFlight().getArrivalAirport().getIaataCode());
